  ...
  return (
    <>
      ...
      <main className='main-projects'>
        ...
        <ProjectCard title='PhoneBook' link={'https://github.com/sebastian-ruiz-7/PhoneBook'} image={phoneBook} description={'This is a site where you can see my last projects and get to know me a little better'}/>
